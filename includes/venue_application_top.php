...
if (!tep_session_is_registered('appevolution_admin_userid') || !tep_session_is_registered('appevolution_admin_usertype') || $appevolution_admin_usertype != 'company' || !tep_session_is_registered('appevolution_venueid') || $appevolution_venueid == 0) {
	tep_redirect(HTTP_CATALOG_SERVER.'logout.php');
}
